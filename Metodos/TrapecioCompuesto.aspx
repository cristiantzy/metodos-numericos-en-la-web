<%@ Page Title="Trapecio Compuesta" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="TrapecioCompuesto.aspx.cs" Inherits="MetodosNumericos.Views.Metodos.TrapecioCompuesto" %>
                ...
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Regla del Trapecio Compuesta</li>
                                        ...
                                        <div class="p-20">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <h5 class="card-title">Regla del Trapecio Compuesta</h5>
                                                            <p>
                                                            ...
                                                            <div style="margin-left: 30%; width: 50%;">
                                                                ...
                                                                <img src="../../Image/trapecio_compuesto.png" class="img-fluid">
                                                            </div>
