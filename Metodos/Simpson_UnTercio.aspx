<%@ Page Title="Simpson 1/3" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="Simpson_UnTercio.aspx.cs" Inherits="MetodosNumericos.Views.Metodos.Simpson_UnTercio" %>
                ...
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Regla de Simpson 1/3</li>
                        ...
                        <div class="container-fluid">
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    <label for="ecuacion_n">Integrales</label>
                                        ...
                                        <div class="p-20">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <h5 class="card-title">Sin Información</h5>
                                                            <p>
                                                                ...
                                                                numérica que se utiliza para obtener la aproximación de la 
                                                                integral:

                                                            </p>
                                                            <div style="margin-left: 30%; width: 50%;">
                                                                <img src="../../Image/simpsonUnTercio.gif" class="img-fluid" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
