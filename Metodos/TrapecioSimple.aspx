<%@ Page Title="Trapecio Simple" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="TrapecioSimple.aspx.cs" Inherits="MetodosNumericos.Views.Metodos.TrapecioSimple" %>
    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center" style="margin-top: -11px;">
                <h4 class="page-title">Regla del <%: Page.Title %></h4>
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/Views/Usuario/Inicio.aspx"><span class="mdi mdi-home"></span>&nbsp;Inicio</a></li>
                            <li class="breadcrumb-item"><a href="#"><span class=""></span>Integracion Numerica</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Regla del Trapecio Simple</li>
                        ...
                        <div class="form-group row" style="height: 157px;">
                            ...
                            <div class="form-group row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <asp:LinkButton ID="graficar_funcion" Style="margin-top: -60px; margin-left: 290px;" class="btn btn-success" OnClick="graficar_funcion_Click" runat="server"><span class="mdi mdi-chart-bar"></span>  Graficar</asp:LinkButton>
                                        ...
                                        <div class="p-20">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <h5 class="card-title">Regla del Trapecio Simple</h5>
                                                            <p>
                                                                En análisis numérico la regla del trapecio es un método de integración,
                                                                es decir, un método para calcular aproximadamente el valor de una integral 
                                                                definida. La regla se basa en aproximar el valor de la integral de f(x) por el de la función lineal,
                                                                que pasa a través de los puntos  (a,f(a)) y (b,f(b). La integral de ésta es igual
                                                            ...
                                                            <div style="margin-left: 30%; width: 50%;">
                                                                ...
                                                                <img src="../../Gif/trapecio_simple.gif" class="img-fluid">
                                                            </div>
